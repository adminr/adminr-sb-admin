...
mod.directive('adminrTable', function() {
  return {
    compile: function(elm, attributes) {
      ...
      ref = elm.find('tbody').filter(function(index, body) {
        return angular.element(body).attr('body-generate-header') !== void 0;
      });
      results = [];
      for (i = 0, len = ref.length; i < len; i++) {
        ...
        results.push(body.before(header));
      }
      return results;
    }
  };
...
mod.provider('AdminrSBAdmin', ["$urlRouterProvider", "$stateProvider", "AdminrContainerManagerProvider", "AdminrLoginProvider", function($urlRouterProvider, $stateProvider, AdminrContainerManagerProvider, AdminrLoginProvider) {
